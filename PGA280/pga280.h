...
void PGA280_EnableMuxControl(PGA280 * data, unsigned char MUX0, unsigned char MUX1, unsigned char MUX2); //habilita controle de multiplexador externo através de GPIO0, GPIO1, GPIO2
